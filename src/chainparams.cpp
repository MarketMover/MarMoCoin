...
public:
    CMainParams() {
        ...
        const char* pszTimestamp = "Market making through moving markets.";
        ...
        assert(hashGenesisBlock == uint256("0x430940f5d2f1813054d5d2f2de1de9a5e7d23f9e709c170b2166657374193b71"));
        assert(genesis.hashMerkleRoot == uint256("c225964a2d3acce3194ae1cb308ececdd72aa50dac7e1daba4aba19be483af67"));

        vSeeds.push_back(CDNSSeedData("54.214.225.202", "54.214.225.202"));
        vSeeds.push_back(CDNSSeedData("54.213.43.30", "54.213.43.30"));
