...
#if defined(NDEBUG)
# error "MarMoCoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "MarMoCoin Signed Message:\n";
...
#ifdef ENABLE_WALLET
// MarMoCoin: attempt to generate suitable proof-of-stake
...
{
    RenameThread("MarMoCoin-loadblk");
